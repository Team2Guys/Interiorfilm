...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-secondary text-white pt-10 px-2 md:px-8 pb-10">
        <div className="flex flex-wrap md:flex-nowrap justify-between border-b pb-10">
          <div className="w-full md:w-4/12 flex flex-wrap items-center justify-between md:justify-start md:flex-nowrap md:gap-4 mx-auto md:mx-0 ">
          ...
          <div className="flex flex-wrap md:*:flex-nowrap items-center justify-start md:justify-end gap-2 w-full md:w-8/12 text-white mt-4 md:mt-0">
        ...
        <div className=" text-white px-0 xsm:px-8">
          <div className=" lg:px-0 md:px-0 mx-auto px-4 lg:pb-0 flex flex-col md:flex-row flex-wrap gap-4 justify-between mt-10">
            ...
            <div className="lg:pb-0 pb-3 ">
              <h3
                className="font-semibold lg:mb-4 mb-2 cursor-pointer md:cursor-auto flex flex-wrap items-center lg:text-lg text-sm justify-between"

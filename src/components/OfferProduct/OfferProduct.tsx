  ...
  return (
    <div className='flex flex-wrap md:gap-10 md:flex-nowrap bg-Offer bg-no-repeat justify-center items-center pb-10 px-2 md:px-20 mt-20'>
        ...
        <div className='w-full md:w-7/12  '>
            <p className='w-full md:w-[90%] text-base md:text-[30px] lg:text-[56px] leading-snug font-medium text-heading mb-4 text-center md:text-justify'>Unique Colorful Of latest & Trending Products</p>

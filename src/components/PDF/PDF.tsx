    ...
    <Container className='grid grid-cols-12 pt-5 pb-5 md:pb-0 items-center justify-items-center relative'>
        <div className='col-span-12 md:col-span-7 relative'>
          <div className=' w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] lg:w-[800px] lg:h-[800px]'>
            <Image fill quality={80} src="/images/pdf.webp" alt='pdf' loading='lazy'/>
          </div>
        </div>
        ...
        <div className='col-span-12 md:col-span-4 space-y-4'>
            ...
            <div className='flex gap-4'>
                <Link href='https://bncmain.s3.eu-north-1.amazonaws.com/catelog.pdf ' target='_blank' className='bg-primary text-white font-medium md:font-semibold px-4 py-2'>Download Now</Link>
            </div>
        </div>
    </Container>
    </div>

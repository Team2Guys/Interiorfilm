          ...
          return (
              ...
              <div className="space-y-2">
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1 w-8/12">
                    ...
                    <span className="font-currency text-14 md:text-16"></span>{' '}
                      <span>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <p>
                  <span className="font-currency text-18"></span>{' '}<span>
            ...
            <div className="text-end mt-2 mb-2">
              <p className="font-bold">
                Total: <span className="font-currency font-bold text-18"></span>{' '}<span>{subtotal}</span>
              </p>
            </div>

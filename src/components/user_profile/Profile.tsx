    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                className={`absolute z-999999 right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-secondary shadow-default dark:border-strokedark dark:bg-boxdark ${dropdownOpen === true ? "block" : "hidden"
                    }`}
            >

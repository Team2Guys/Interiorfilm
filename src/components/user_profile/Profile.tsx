...
console.log(loggedInUser, "loggedInUser")
    ...
    const items: MenuProps['items'] = [
        ...
        {
          key: '2',
          label: ( <button className="flex items-center gap-3.5  text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base text-black dark:text-white" onClick={logoutHhandler}>
            <svg
                className="fill-current"
                width="22"
                height="22"

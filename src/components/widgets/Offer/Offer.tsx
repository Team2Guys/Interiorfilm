        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10 gap-2 md:gap-4'>
            {
                Offers.map((array,index)=>(
                    ...
                    <div className='custom-shadow p-1 md:p-2  group-hover:shadow-lg flex flex-col justify-center items-center space-y-3 pt-10 pb-10 px-1 md:px-4 h-72 transition duration-500 ease-in-out' >
